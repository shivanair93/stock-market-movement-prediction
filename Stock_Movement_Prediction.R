...
terms <- c("Chevrolet","OnStar")
date_begin <- "11/1/2008"
date_end <- "12/1/2019"

### Prepare data
setwd("C:/Users/Shiva/Dropbox/III Sem/financial analysis")
...
date_market <- data.frame(index(GM))   # ??? Change to data frame

# Get Open_Price, Close_Price, High_Price, Low_Price


data_from_yahoo <- GM # ? How to change this using input ???? try noquote(stock), not working
...
### Conclusion :
##### Model Has around 78% accuracy with SVM and 76% with Random Forest.